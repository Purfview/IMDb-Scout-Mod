...
var public_sites = [
  ...
  {   'name': '1337x-Proxy',
      'icon': 'https://i.imgur.com/3PI1RlA.png',
      'searchUrl': 'https://1337x.unblockit.app/category-search/%search_string%+%year%/Movies/1/',
      'matchRegex': /No results were returned/},
  {   'name': '1337x-Proxy',
      'icon': 'https://i.imgur.com/3PI1RlA.png',
      'searchUrl': 'https://1337x.unblockit.app/category-search/%search_string%/TV/1/',
      'matchRegex': /No results were returned/,
      'TV': true},
  {   'name': 'ArenaBG',
  ...
  {   'name': 'LimeTor-Proxy',
      'icon': 'https://i.imgur.com/cLRWNQK.png',
      'loggedOutRegex': /Ray ID|security check to access|Please turn JavaScript/,
      'searchUrl': 'https://limetorrents.unblockit.app/search/movies/%search_string%+%year%/seeds/1/',
      'matchRegex': /csprite_dl14/,
      'positiveMatch': true},
  {   'name': 'LimeTor-Proxy',
      'icon': 'https://i.imgur.com/cLRWNQK.png',
      'loggedOutRegex': /Ray ID|security check to access|Please turn JavaScript/,
      'searchUrl': 'https://limetorrents.unblockit.app/search/tv/%search_string%/seeds/1/',
      'matchRegex': /csprite_dl14/,
      'positiveMatch': true,
      'TV': true},
  {   'name': 'MVG',
  ...
  {   'name': 'TorDL-Proxy',
      'icon': 'https://i.imgur.com/N0pLxiZ.png',
      'searchUrl': 'https://torrentdownloads.unblockit.app/search/?new=1&s_cat=0&search=%search_string%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': /No results found/,
      'both': true},
  {   'name': 'TPB',
  ...
  {   'name': 'TPB-Proxy',
      'searchUrl': 'https://apibay.org/q.php?q=%search_string%&cat=201,202,207,209',
      'goToUrl': 'https://pirateproxy.buzz/search.php?q=%search_string%&cat=201,202,207,209',
      'loggedOutRegex': /Ray ID/,
      'matchRegex': /No results/},
  {   'name': 'TPB-Proxy',
      'searchUrl': 'https://apibay.org/q.php?q=%search_string%&cat=205,208',
      'goToUrl': 'https://pirateproxy.buzz/search.php?q=%search_string%&cat=205,208',
      'loggedOutRegex': /Ray ID/,
      'matchRegex': /No results/,
      'TV': true},
  {   'name': 'TVU',
...
var private_sites = [
  ...
  {   'name': 'DesiRel',
      ...
      'both': true},
  {   'name': 'DKBits',
      'searchUrl': 'https://dkbits.org/torrents/filter?imdb=%tt%',
      'loggedOutRegex': /Cloudflare|Ray ID|Forgot Your Password/,
      'matchRegex': /<tbody>\s*<\/tbody>/,
      'both': true},
  {   'name': 'DT',
  ...
  {   'name': 'SI',
      ...
      'loggedOutRegex': /Cloudflare|Ray ID|Accedi con le tue credenziali|Sign In With Your Credentials/,
      'matchRegex': /<tbody>\s*<\/tbody>/,
      'both': true},
  {   'name': 'Snahp',
  ...
  {   'name': 'THC',
      ...
      'matchRegex': /Nothing found!/},
  {   'name': 'Thor-Island',
      'searchUrl': 'https://thor-island.tk/torrents/filter?imdb=%tt%',
      'loggedOutRegex': /Cloudflare|Ray ID|Forgot Your Password/,
      'matchRegex': /<tbody>\s*<\/tbody>/,
      'both': true},
  {   'name': 'THR',
