...
var public_sites = [
  ...
  {   'name': 'SkT',
      ...
      'both': true},
  {   'name': 'SolidTor',
      'icon': 'https://solidtorrents.eu/favicon-solidtorrents.ico',
...
var private_sites = [
  ...
  {   'name': 'T',
      ...
      'TV': true},
  {   'name': 'Tasmanites',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'Uniongang',
      ...
      'both': true},
  {   'name': 'UniOtaku',
      'icon': 'https://tracker.uniotaku.com/favicon.svg',
...
var usenet_sites = [
  ...
  {   'name': 'GingaDADDY',
      ...
      'both': true},
  {   'name': 'HDUse',
      'icon': 'data:image/png;base64,',
...
var streaming_sites = [
  {   'name': '9anime',
      ...
      'searchUrl': 'https://9anime.to/filter?keyword=+%search_string%',
