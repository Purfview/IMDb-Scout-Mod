...
var public_sites = [
  ...
  {   'name': 'CineCalidad',
      ...
      'both': true},
  {   'name': 'Comando4K',
      'icon': 'https://comando4ktorrents.net/wp-content/themes/comando4ktorrents/images/favicon.ico',
      'searchUrl': 'https://comando4ktorrents.net/?s=%tt%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
...
var private_sites = [
  ...
  {   'name': 'BigBBS',
      ...
      'positiveMatch': true},
  {   'name': 'BitBR',
      'searchUrl': 'https://bitbr.cc/torrents.php?search=%tt%&search_area=4&search_mode=0',
      'loggedOutRegex': /Cloudflare|Ray ID|Não Logado/,
...
var french_sites = [
  ...
  {   'name': 'TCTG',
      ...
      'TV': true},
  {   'name': 'Tor911',
      'icon': 'https://www.torrent911.org/themes/default/img/favicon.ico',
      'searchUrl': 'https://www.torrent911.org/recherche/%search_string_orig%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
